  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:site_name", content: "链途resume" },
        { property: "og:title", content: seo.title },
        { property: "og:description", content: seo.description },
        { property: "og:locale", content: seo.localeTag },
        { property: "og:url", content: seo.canonical },
        { property: "og:image", content: `${SEO_BASE_URL}/${locale === "en" ? "web-shot-en" : "web-shot"}.png` },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: seo.title },
        { name: "twitter:description", content: seo.description },
        { name: "twitter:image", content: `${SEO_BASE_URL}/${locale === "en" ? "web-shot-en" : "web-shot"}.png` }
      ],
      links: [
